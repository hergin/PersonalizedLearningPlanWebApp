...
SELECT m.id as id, m.content as content, m.date as date, m.recipient_id as recipient_id, m.sender_id as sender_id, p.username as username, p.profile_picture as profile_picture
